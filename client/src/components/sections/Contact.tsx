          ...
          <div className="w-full lg:w-5/12 space-y-8">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Ready for a spotless home or office? Fill out the form and
                we’ll send your request instantly.
              </p>
            </div>
